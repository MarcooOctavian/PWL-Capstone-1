...
@section('content')
    ...
    <section class="blog-hero-section set-bg" data-setbg="{{ asset('user/img/blog/blog-details/blog-details-hero.jpg') }}">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="bh-text">
                        ...
                        <h2>Maranatha Tech Conference 2026</h2>
                        <ul>
                ...
                <div class="col-lg-8 m-auto">
                    <div class="bd-text">
                        ...
                        <div class="bd-quote">
                            ...
                            <img src="{{ asset('user/img/quote-left.png') }}" alt="">
                        </div>
                        ...
                        <div class="bd-more-pic">
                            <div class="row">
                                <div class="col-md-6">
                                    <img src="{{ asset('user/img/blog/blog-details/blog-more-1.jpg') }}" alt="">
                                </div>
                                <div class="col-md-6">
                        ...
                        <div class="bd-tag-share">
                            ...
                            <div class="text-center mt-5 mb-5">
                                <a href="{{ route('checkout.payment') }}" class="primary-btn">Pesan Tiket Sekarang</a>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <section class="related-post-section spad">
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="blog-item set-bg" data-setbg="{{ asset('user/img/related-post/related-post-1.jpg') }}">
